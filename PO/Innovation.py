...
def innovation_home(poco):
    ...
    try:
        ...
        print(repr(ex))
        assert_equal(False, True, '培育创新图标发生异常')
    time.sleep(3)
    try:
        ...
        assert_equal(False, True, '未发现培育创新标题')
...
def innovation_result_detail_from_pic(poco):
    ...
    try:
        ...
        print(repr(ex))
        assert_equal(False, True, '未发现成果文字')
    # 获取成果名称
    try:
    ...
    try:
        ...
        assert_equal(False, True, '未发现详情标题')
    # 获取详情标题
...
def innovation_result_list_search(poco):
    ...
    if len(result_list) > 0:
        ...
        assert_equal(False, True, '成果列表查询无结果')
...
def innovation_developments_details(poco):
    ...
    if len(developments_list) > 0:
        ...
        assert_equal(False, True, '无创新动态')


# 共同体首页
def innovation_community_home(poco):
    poco(text="成果概览").swipe('down')
    sleep(2)
    ...
    if len(community_list) > 0:
        ...
        assert_equal(False, True, '无共同体记录')
